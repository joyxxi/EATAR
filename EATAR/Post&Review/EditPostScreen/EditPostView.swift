...
class EditPostView: UIView {
    ...
    func setupRestaurantField() {
        ...
        restaurantField.text = "Shang Cafe"
    ...
    func setupCuisineButton() {
        ...
        cuisineButton.setTitle("Chinese", for: .normal)
    ...
    func setupPeopleButton() {
        ...
        peopleButton.setTitle("4", for: .normal)
    ...
    func setupDateButton() {
        ...
        dateButton.setTitle("10/13/24 Dinner", for: .normal)
    ...
    func setupLocationField() {
        ...
        locationField.text = "XX St, San Jose, CA"
    ...
    func initConstraints() {
        NSLayoutConstraint.activate([
            ...
            saveButton.leadingAnchor.constraint(equalTo: self.safeAreaLayoutGuide.leadingAnchor, constant: horizontalPadding),
            saveButton.trailingAnchor.constraint(equalTo: self.safeAreaLayoutGuide.trailingAnchor, constant: -horizontalPadding),

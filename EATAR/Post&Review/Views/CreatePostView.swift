...
class CreatePostView: UIView {
    ...
    func setupTitle() {
        labelTitle = UILabel()
        labelTitle.text = "Create a New Post"
    ...
    func setupPostButton() {
        ...
        buttonPost.backgroundColor = .systemBrown
        buttonPost.setTitleColor(.white, for: .normal)
        buttonPost.layer.cornerRadius = 8
    ...
    func initConstraints() {
        NSLayoutConstraint.activate([
            ...
            buttonPost.topAnchor.constraint(equalTo: textViewNote.bottomAnchor, constant: 24),
            buttonPost.centerXAnchor.constraint(equalTo: self.centerXAnchor),
            buttonPost.widthAnchor.constraint(equalToConstant: 200),
            buttonPost.heightAnchor.constraint(equalToConstant: 44)
        ])
    }
}
